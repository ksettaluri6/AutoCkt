...
class TwoStageAmp(gym.Env):
    ...
    CIR_YAML = "/tools/projects/ksettaluri6/BAG2_TSMC16FFC_tutorial/bag_deep_ckt/eval_engines/spectre/specs_test/vanilla_two_stage_opamp_45nm.yaml"
    ...
    def __init__(self, env_config):
        ...
        if generalize == False:
            ...
            load_specs_path = "/tools/projects/ksettaluri6/BAG2_TSMC16FFC_tutorial/bag_deep_ckt/autockt/gen_specs/specs_gen_spectre_opamp_simple_45nm"
...
#        self.cur_params_idx = self.cur_params_idx + np.array(self.action_arr[int(action)])
    ...
    def update(self, params_idx):
        ...
        param_val[0]['tail']=32.0
        param_val[0]['in']=32.0
        param_val[0]['gm']=32.0
        param_val[0]['load']=32.0
        param_val[0]['mir']=32.0
        param_val[0]['gm']=32.0
        param_val[0]['cc']=30e-12
