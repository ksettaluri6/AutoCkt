...
if __name__ == "__main__":
    ...
    netlist_path = os.path.join(
        parent_path, "../eval_engines/ngspice/ngspice_inputs/netlist"
    )
    spice_model = os.path.join(
        parent_path, "../eval_engines/ngspice/ngspice_inputs/spice_models/45nm_bulk.txt"
    )
